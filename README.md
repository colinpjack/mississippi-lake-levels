...
| `.github/workflows/update.yml` | Runs ~**8:00, 13:00, 18:00** Eastern and deploys Pages |
...
- Schedule cron is in **UTC** aligned to Eastern **Daylight** Time; in winter you may want `0 13,18,23 * * *` instead.
